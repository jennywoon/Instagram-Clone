...
//         name="username" onChange={onChangeusername} value={username} type="text"
//         />
//         <Input width='200px' padding='12px 20px' placeholder='닉네임'
//         name="nickname" onChange={onChangenickname} value={nickname} type="text"
//         />
//         <Input width='200px' padding='12px 20px' placeholder='비밀번호' 
//         name="password" onChange={onChangePassword} value={password} type="password"
//         />
//         <Input width='200px' padding='12px 20px' placeholder='비밀번호 확인'
//         name="validPassword" onChange={onChangeValidPassword} value={validPassword} type="password"
//         />
//         <Button
//           width='245px'
//           padding='10px 0px'
